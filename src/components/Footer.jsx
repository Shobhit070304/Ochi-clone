  ...
  return (
    <div className="w-full h-screen flex  bg-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div>
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-3 tracking-tighter">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-6 tracking-tighter">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] font-semibold uppercase text-center leading-none tracking-tighter">
          Presentations
        </h1>
